...
describe('MochaWebpack', function() {
  ...
  context('methods', function() {
    ...
    it('addInclude()', function() {
      ...
      assert.notStrictEqual(
        this.mochaWebpack.includes,
        oldIncludes,
        'addInclude() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('cwd()', function() {
      ...
      assert.propertyVal(
        ...
        'cwd',
        cwd,
        'cwd should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'cwd() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('bail()', function() {
      ...
      assert.propertyVal(
        ...
        'bail',
        bail,
        'bail should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'bail() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('reporter()', function() {
      ...
      assert.propertyVal(
        ...
        'reporterOptions',
        reporterOptions,
        'reporterOptions should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
    ...
    it('invert()', function() {
      ...
      assert.propertyVal(
        ...
        'invert',
        true,
        'invert should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'invert() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('ignoreLeaks()', function() {
      ...
      assert.propertyVal(
        ...
        'ignoreLeaks',
        ignoreLeaks,
        'ignoreLeaks should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'ignoreLeaks() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('fullStackTrace()', function() {
      ...
      assert.propertyVal(
        ...
        'fullStackTrace',
        fullStackTrace,
        'fullStackTrace should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'fullStackTrace() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('useInlineDiffs()', function() {
      ...
      assert.propertyVal(
        ...
        'useInlineDiffs',
        useInlineDiffs,
        'useInlineDiffs should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'useInlineDiffs() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('retries()', function() {
      ...
      assert.propertyVal(
        ...
        'retries',
        retries,
        'retries should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'retries() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('slow()', function() {
      ...
      assert.propertyVal(
        ...
        'slow',
        slow,
        'slow should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'slow() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('asyncOnly()', function() {
      ...
      assert.propertyVal(
        ...
        'asyncOnly',
        true,
        'asyncOnly should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'asyncOnly() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('delay()', function() {
      ...
      assert.propertyVal(
        ...
        'delay',
        true,
        'delay should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'delay() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('interactive()', function() {
      ...
      assert.propertyVal(
        ...
        'interactive',
        newValue,
        'interactive should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'interactive() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('clearTerminal()', function() {
      ...
      assert.propertyVal(
        ...
        'clearTerminal',
        clearTerminal,
        'clearTerminal should be changed'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'clearTerminal() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('growl()', function() {
      ...
      assert.propertyVal(
        ...
        'growl',
        true,
        'growl should be changed to true'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'growl() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
    ...
    it('forbidOnly()', function() {
      ...
      assert.propertyVal(
        ...
        'forbidOnly',
        true,
        'forbidOnly should be changed to true'
      )
      assert.notStrictEqual(
        this.mochaWebpack.options,
        oldOptions,
        'forbidOnly() should not mutate'
      )
      assert.strictEqual(
        returnValue,
        this.mochaWebpack,
