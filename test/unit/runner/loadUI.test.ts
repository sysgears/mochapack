...
describe('loadUI', function() {
  ...
  it('should load interface from node_modules', function() {
    ...
    assert.strictEqual(
      ui,
      require.resolve('mocha/lib/interfaces/tdd'),
      'should equal node_module ui'
    )
  })
  ...
  it('should load interface relative from real cwd (1)', function() {
    ...
    assert.strictEqual(
      ui,
      path.join(process.cwd(), './test/fixture/customMochaReporter.js'),
      'should equal custom ui'
    )
  })
  ...
  it('should load interface with relative path from custom cwd', function() {
    ...
    assert.strictEqual(
      ui,
      path.join(__dirname, '../../fixture/customMochaReporter.js'),
      'should equal custom ui'
    )
  })
