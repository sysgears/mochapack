...
describe('parseArgv', function () {
  ...
  context('options', function () {
    ...
    context('reporter-options', function () {
      ...
      const parameters = [{ given: ['--reporter-options', 'foo=bar,quux'], expected: { foo: 'bar', quux: true } }, { given: ['--reporter-options', 'foo=bar,quux,bar=foo'], expected: { foo: 'bar', quux: true, bar: 'foo' } }, { given: ['--reporter-options', 'foo=bar,quux,bar=foo'], expected: { foo: 'bar', quux: true, bar: 'foo' } }, { given: ['--O', 'foo=bar'], expected: { foo: 'bar' } }, { given: ['-O', 'foo=bar'], expected: { foo: 'bar' } }];
    ...
    context('reporter', function () {
      ...
      const parameters = [{ given: ['--reporter', 'dot'], expected: 'dot' }, { given: ['--R', 'dot'], expected: 'dot' }, { given: ['-R', 'dot'], expected: 'dot' }];
    ...
    context('grep', function () {
      ...
      const parameters = [{ given: ['--grep', 'test'], expected: 'test' }, { given: ['--g', 'test'], expected: 'test' }, { given: ['-g', 'test'], expected: 'test' }];
    ...
    context('fgrep', function () {
      ...
      const parameters = [{ given: ['--fgrep', 'test'], expected: 'test' }, { given: ['--f', 'test'], expected: 'test' }, { given: ['-f', 'test'], expected: 'test' }];
    ...
    context('require', function () {
      ...
      const parameters = [{ given: ['--require', 'test'], expected: ['test'] }, { given: ['--require', 'test', '--require', 'test2'], expected: ['test', 'test2'] }, { given: ['--r', 'test'], expected: ['test'] }, { given: ['-r', 'test'], expected: ['test'] }];
    ...
    context('include', function () {
      ...
      const parameters = [{ given: ['--include', 'test'], expected: ['test'] }, { given: ['--include', 'test', '--include', 'test2'], expected: ['test', 'test2'] }];
    ...
    context('slow', function () {
      ...
      const parameters = [{ given: ['--slow', '1000'], expected: 1000 }, { given: ['--slow', '-1'], expected: -1 }, { given: ['--s', '1000'], expected: 1000 }, { given: ['-s', '1000'], expected: 1000 }, { given: ['-s', '-1'], expected: -1 }];
    ...
    context('timeout', function () {
      ...
      const parameters = [{ given: ['--timeout', '1000'], expected: 1000 }, { given: ['--t', '1000'], expected: 1000 }, { given: ['-t', '1000'], expected: 1000 }];
    ...
    context('ui', function () {
      ...
      const parameters = [{ given: ['--ui', 'tdd'], expected: 'tdd' }, { given: ['--u', 'tdd'], expected: 'tdd' }, { given: ['-u', 'tdd'], expected: 'tdd' }];
    ...
    context('retries', function () {
      ...
      const parameters = [{ given: ['--retries', '2'], expected: 2 }];
    ...
    context('webpack-config', function () {
      ...
      const parameters = [{ given: ['--webpack-config', 'webpack-config.js'], expected: 'webpack-config.js' }];
    ...
    context('webpack-env', function () {
      ...
      const parameters = [{ given: ['--webpack-env', 'production'], expected: 'production' }, { given: ['--webpack-env.env', 'production'], expected: { env: 'production' } }, { given: ['--webpack-env.anotherEnv', 'test'], expected: { anotherEnv: 'test' } }, {
    ...
    context('opts', function () {
      ...
      const parameters = [{ given: ['--opts', 'path/to/other.opts'], expected: 'path/to/other.opts' }];
    ...
    context('mode', function () {
      ...
      const parameters = [{ given: ['--mode', 'development'], expected: 'development' }, { given: ['--mode', 'production'], expected: 'production' }];
