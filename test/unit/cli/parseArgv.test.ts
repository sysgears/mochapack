...
describe('parseArgv', function() {
  ...
  context('options', function() {
    ...
    context('reporter-options', function() {
      ...
      const parameters = [
        {
          given: ['--reporter-options', 'foo=bar,quux'],
          expected: { foo: 'bar', quux: true }
        },
        {
          given: ['--reporter-options', 'foo=bar,quux,bar=foo'],
          expected: { foo: 'bar', quux: true, bar: 'foo' }
        },
        {
          given: ['--reporter-options', 'foo=bar,quux,bar=foo'],
          expected: { foo: 'bar', quux: true, bar: 'foo' }
    ...
    context('require', function() {
      ...
      const parameters = [
        ...
        {
          given: ['--require', 'test', '--require', 'test2'],
          expected: ['test', 'test2']
        },
    ...
    context('opts', function() {
      ...
      const parameters = [
        {
          given: ['--opts', 'path/to/other.opts'],
          expected: 'path/to/other.opts'
        }
      ]
